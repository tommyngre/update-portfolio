  ...
  switch (section) {
    case "#ABOUT":
      ...
      <ul class="sm-txt">
        ...
        <li>Since Feb-Aug 2018, 24 week <b>full stack web dev</b> program through <b class="underline-link" style="color:${assignRandomColor()}">Trilogy Education Services and UNC Chapel Hill</b>
      </ul> 
      `
      return html;
      break;
